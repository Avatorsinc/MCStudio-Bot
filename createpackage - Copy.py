...
# Set a global delay for smoother execution
pyautogui.PAUSE = 1.5
...
def create_package(project_name, json_file_path):
    try:
        ...
        target_window.activate()  # Ensure the window is focused
        time.sleep(1)
       ...
       # add_files_coordinates = (-91, 125)  # Verified coordinates for "Add Files"
       ...
       # time.sleep(2)
        ...
        pre_install_coordinates = (-1814, 206)  # Verified coordinates for Pre-Install
        pyautogui.rightClick(pre_install_coordinates)
        time.sleep(2)

        pre_install_edit_coordinates = (-1769, 243)  # Verified coordinates for Edit option
